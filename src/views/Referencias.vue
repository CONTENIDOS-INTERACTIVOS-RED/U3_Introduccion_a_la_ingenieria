...
.curso-main-container.referencias
  BannerInterno.text-uppercase(icono="fas fa-book" subTitulo="Referencias bibliográficas" titulo="unidad 3. Pensamiento Crítico y solución de problemas en ingeniería")
